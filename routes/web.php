...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/users/assign-role', [AdminController::class, 'assignRole'])->name('admin.assignRole');
    Route::post('/admin/users/assign-permission', [AdminController::class, 'assignPermission'])->name('admin.assignPermission');
